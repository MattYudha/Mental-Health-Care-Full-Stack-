  ...
  const resources = [
    {
      ...
      description: '24/7 confidential helpline for those experiencing gambling problems',
      type: 'hotlines',
    ...
    },
    {
      ...
      description: 'Comprehensive guide to understanding the causes and effects of gambling addiction',
      type: 'articles',
    ...
    },
    {
      ...
      description: 'Virtual support group meetings for people dealing with gambling problems',
      type: 'groups',
    ...
    },
    {
      ...
      description: 'Step-by-step guide to rebuilding finances after gambling problems',
      type: 'articles',
    ...
    },
    {
      ...
      description: 'How mindfulness practices can support recovery from addictive behaviors',
      type: 'videos',
      duration: '22 minutes',
    ...
    },
    {
      ...
      description: 'Find in-person gambling addiction support groups in your area',
      type: 'groups',
      locations: 'Nationwide',
      website: 'https://www.ncpgambling.org/help-treatment/treatment-facilities/'
    }
  ];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Access professional help and educational materials</p>
      </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {featuredResources.map(resource => (
                <div key={resource.id} className="border border-teal-200 bg-teal-50 rounded-lg p-4">
                  <div className="flex items-start">
                    <div className="bg-teal-100 p-2 rounded-full text-teal-600 mr-3">
                      {resource.type === 'hotlines' ? <PhoneCall size={20} /> : 
                       resource.type === 'articles' ? <FileText size={20} /> :
                       resource.type === 'videos' ? <Video size={20} /> :
                       <Users size={20} />}
                    </div>
                    <div className="flex-1">
                      <div className="flex justify-between items-start">
                        <h3 className="text-base font-medium text-gray-800">{resource.title}</h3>
                      ...
                      <div className="mt-3 flex flex-wrap items-center text-sm">
                        ...
                        {(resource.website || resource.source) && (
                          <a href="#" className="flex items-center text-teal-600 hover:text-teal-700 mt-2">
                            <ExternalLink size={14} className="mr-1" />
                            <span>Visit {resource.website ? 'Website' : 'Source'}</span>
                          </a>
                        )}
                      </div>
                    </div>
        ...
        <div>
          <h2 className="text-lg font-semibold text-gray-800 mb-4">
            {activeCategory === 'all' ? 'All Resources' : 
             activeCategory === 'hotlines' ? 'Helplines & Hotlines' :
             activeCategory === 'articles' ? 'Articles & Guides' :
             activeCategory === 'videos' ? 'Videos & Webinars' :
             'Support Groups'}
          </h2>
          ...
          {filteredResources.length === 0 ? (
            ...
            <div className="space-y-4">
              {filteredResources.map(resource => (
                <div key={resource.id} className="border border-gray-200 rounded-lg p-4 transition-colors hover:bg-gray-50">
                  <div className="flex items-start">
                    <div className={`p-2 rounded-full mr-3 ${
                      resource.type === 'hotlines' ? 'bg-blue-100 text-blue-600' : 
                      resource.type === 'articles' ? 'bg-purple-100 text-purple-600' :
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-3 flex flex-wrap items-center text-sm space-x-4">
                        ...
                        {resource.type === 'videos' && resource.source && (
                          <div className="flex items-center text-gray-500">
                        ...
                        {resource.type === 'groups' && resource.locations && (
                          <div className="flex items-center text-gray-500">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="md:w-2/3 mb-6 md:mb-0 md:pr-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              If you're experiencing a gambling-related crisis or need to talk to someone right away, 
              these national hotlines are available 24/7:
            </p>
            <div className="space-y-3">
              <div className="flex items-center p-3 bg-white rounded-lg">
                <PhoneCall className="h-5 w-5 text-blue-500 mr-3" />
                <div>
                  <p className="text-sm font-medium text-gray-800">National Problem Gambling Helpline</p>
                  <p className="text-sm text-blue-600">1-800-522-4700</p>
                </div>
              </div>
              <div className="flex items-center p-3 bg-white rounded-lg">
                <PhoneCall className="h-5 w-5 text-blue-500 mr-3" />
                <div>
                  <p className="text-sm font-medium text-gray-800">SAMHSA's National Helpline</p>
                  <p className="text-sm text-blue-600">1-800-662-HELP (4357)</p>
                </div>
              </div>
            </div>
          </div>
          <div className="md:w-1/3 bg-white p-4 rounded-lg">
            <h3 className="text-base font-medium text-gray-800 mb-3">Crisis Support</h3>
            <p className="text-sm text-gray-600 mb-4">
              These services provide immediate support for those in crisis:
            </p>
            <button className="w-full mb-2 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium transition-colors">
              Call Crisis Line
            </button>
