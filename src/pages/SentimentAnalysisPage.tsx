...
import { AlertTriangle, BookOpen, MessagesSquare, Search } from "lucide-react";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Monitor conversations for signs of gambling behaviors
        </p>
      </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-sm text-gray-700 mb-3">
                Your risk assessment indicates moderate concerns related to
                gambling behaviors. Key issues identified:
              </p>
