  ...
  const [conversation, setConversation] = useState([
    {
      ...
      sender: "bot",
      message:
        "Hello! I'm MindGuard, your supportive AI assistant. How are you feeling today?",
      timestamp: "10:30 AM",
    },
    {
      id: 2,
      sender: "user",
      message:
        "I've been feeling stressed about my gambling habits. I spent more than I should have last night.",
      timestamp: "10:31 AM",
    },
    {
      id: 3,
      sender: "bot",
      message:
        "I'm sorry to hear you're feeling stressed. It takes courage to acknowledge concerns about gambling habits. Would you like to talk more about what happened last night, or would you prefer some techniques to manage the stress you're feeling right now?",
      timestamp: "10:31 AM",
    },
    {
      id: 4,
      sender: "user",
      message:
        "I think I need help with the stress first. I feel really anxious about the money I lost.",
      timestamp: "10:32 AM",
    },
    {
      id: 5,
      sender: "bot",
      message:
        "That's understandable. Financial stress can be particularly challenging. Let's try a quick breathing exercise that can help reduce anxiety. Take a slow, deep breath in through your nose for 4 counts, hold it for 2, and then exhale through your mouth for 6 counts. Would you like to try this together?",
      timestamp: "10:33 AM",
    },
  ]);
  ...
  const sendMessage = () => {
    ...
    setTimeout(() => {
      const botResponse = {
        ...
        sender: "bot",
        message:
          "Thank you for sharing that. Remember that acknowledging your feelings is an important step. Would you like to explore some strategies to help manage gambling urges when they arise?",
        timestamp: new Date().toLocaleTimeString([], {
          hour: "2-digit",
          minute: "2-digit",
        }),
